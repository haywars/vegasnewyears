...
$(document).ready(function() {
    ...
    setInterval('countdown(2012,1,1,0, "NY")', 1000);
    
    $('#seo').die().live('click',function() { // enables the seo button
    ...
    $('#market_dd').click(function() {
        $('#market_dd ul').slideToggle('fast', function() {     
        });
    });
    $('#market_dd').mouseleave(function() {
        if ($('#market_dd ul').css('display') == 'block') {
            $('#market_dd ul').slideToggle('fast', function() {     
            });
        }
    });

    $('#market-sb').on('click',function(){
